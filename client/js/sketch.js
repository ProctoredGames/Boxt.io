...
function drawMinimap(thisIndex){
	push()
	strokeWeight(0);
	translate(windowWidth-(biomeSize/50+biomeSize/50+biomeSize/50)-windowHeight*0.02, windowHeight*0.04)

	//desert
	fill(0, 0, 220);
	rect(0, 0, biomeSize/50, 80);
	fill(231, 183, 68);
	rect(0, 80, biomeSize/50, 20);

	//plains
	fill(0, 0, 180);
	rect(biomeSize/50, 0, biomeSize/50, 80);
	fill(0,150,0);
	rect(biomeSize/50, 80, biomeSize/50, 20);

	//jungle
	fill(0, 0, 200);
	rect(biomeSize/50+biomeSize/50, 0, biomeSize/50, 80);
	fill(0,120,0);
	rect(biomeSize/50+biomeSize/50, 80, biomeSize/50, 20);

	strokeWeight(0);

	fill(255,255,255);
	circle(players[thisIndex].x/50, 77.5, 10)

	var rankedPlayers = quickSort(players);

	image(crownImg, rankedPlayers[0].x/50, 77.5, 15, 15)

	text("Version 3.18.24", windowHeight*0.025, 120, windowHeight*0.25, windowHeight*0.03)
